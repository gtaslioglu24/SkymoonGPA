...
const tr = {
  ...
  result: {
    ...
    vehbiKoc: 'Bu dönem ortalamanla Vehbi Koç Onur Listesi eşiğindesin (dönem 3.75+).',
    deansHonor: 'Dekan Şeref Listesi eşiğindesin (dönem ve genel ortalama 3.25+).',
...
const en: Dict = {
  ...
  result: {
    ...
    vehbiKoc: 'This term’s average puts you at the Vehbi Koç Honour List threshold (term 3.75+).',
    deansHonor: 'You’re at the Dean’s Honour List threshold (term and cumulative 3.25+).',
